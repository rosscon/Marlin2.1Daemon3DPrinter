 ...
 */
void fio_shiftOut1(fio_register shift1Register, fio_bit shift1Bit, uint8_t value, bool noLatch = false);
/*!
 * @method
 * @abstract one wire shift out
 * @discussion protocol needs initialisation (fio_shiftOut1_init)
 ...
 * @param value[in] value to shift out, last byte is ignored and always shifted out LOW
 */
void fio_shiftOut1(uint8_t pin, uint8_t value, bool noLatch = false);
/*!
 * @method
